...
export function HoneymoonTrips() {
  const navigate = useNavigate();
  
  const handleSendQuery = (trip: any) => {
    const message = `I'm interested in the ${trip.title} (${trip.duration}) Honeymoon package - ₹${trip.price}`;
  ...
  const trips = [
    {
      ...
      description: "Romantic getaway in the peaceful valleys of Himachal Pradesh.",
      price: 7999,
      originalPrice: 9999,
      duration: "4 days"
    },
    ...
    <div className="min-h-screen bg-gray-100 py-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-center mb-12">
          ...
          <h1 className="text-4xl font-bold">Honeymoon Trips</h1>
        </div>
