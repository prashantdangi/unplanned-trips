...
export function BackpackingTrips() {
  const navigate = useNavigate();
  
  const handleSendQuery = (trip: any) => {
    const message = `I'm interested in the ${trip.title} (${trip.duration}) Backpacking package - ₹${trip.price}`;
    ...
    <div className="min-h-screen bg-gray-100 py-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-center mb-12">
          <Backpack className="w-12 h-12 text-blue-600 mr-4" />
          <h1 className="text-4xl font-bold">Backpacking Trips</h1>
        </div>
